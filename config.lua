...
--regional - kanto
KANTO_STARTER_ID = math.random(2,4)          -- nil: random, 1: Fatvegan, 2: Salamender, 3: Aquaturtle, 4: Mickeychu. Bulbasaur is a really bad starter if let it attack manually.
